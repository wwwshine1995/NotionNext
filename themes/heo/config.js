const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-08-21', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: 'kind and truth', url: 'https://andrewen.art' },
  ],
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/wwwshine1995',
