...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'andre', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'warmful', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://andrewen.art', // 网站地址
