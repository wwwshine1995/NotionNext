...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '85dee0e693f54b43b6a9989d26949b7c',
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.medium
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的工程师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://andrewen.top', // 网站地址
